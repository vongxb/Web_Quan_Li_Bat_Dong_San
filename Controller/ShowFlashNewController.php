<?php
    include('../Connect.php');
    $query = mysqli_query($conn,"SELECT DISTINCT NewImage.NewID,NewName,NewContent,NewDatePost,NewCount,NewImageLink 
                                FROM News INNER JOIN NewImage on News.NewID = NewImage.NewID ORDER BY NewDatePost DESC LIMIT 3");
    $array = array();
